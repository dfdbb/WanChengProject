...
public class TableUtils {
    ...
    public static <T, R, C, V> Table<R, C, V> createHashTable(Iterable<T> source, Function<? super T, ? extends R> r, Function<? super T, ? extends C> c, Function<? super T, ? extends V> v) {
        ...
        source.forEach(e -> table.put(xin.altitude.cms.common.util.EntityUtils.toObj(e, r), xin.altitude.cms.common.util.EntityUtils.toObj(e, c), EntityUtils.toObj(e, v)));
        return table;
    }
